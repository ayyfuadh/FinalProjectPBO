...
public class Game extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        if (isRunning) {
            ...
            g2.setColor(Color.black);
             g.setFont(new Font("Arial", 1, 20));
            g2.drawString("           Enter to Start", Window.WIDTH / 2 - 150, Window.HEIGHT / 2);
            g2.setColor(Color.black);
            g.setFont(new Font("Arial", 1, 15));
            g2.drawString("Powered by Ayyi Fuadah", Window.WIDTH - 200, Window.HEIGHT - 50);
        }
        g2.setColor(Color.black);
        g.setFont(new Font("Arial", 1, 20));
        g2.drawString("Top Score: " + highScore, Window.WIDTH - 160, 20);
